...
@Component({
  selector: 'app-age-of-firm-dialog',
  templateUrl: './age-of-firm-dialog.component.html',
  styleUrls: ['./age-of-firm-dialog.component.css']
})
export class AgeOfFirmDialogComponent implements OnInit {
  private readonly matDialogRef: MatDialogRef<AgeOfFirmDialogComponent>;
  ...
  constructor(
    matDialogRef: MatDialogRef<AgeOfFirmDialogComponent>,
