...
@Component({
  selector: 'app-plant-and-machinery-dialog',
  templateUrl: './plant-and-machinery-dialog.component.html',
  styleUrls: ['./plant-and-machinery-dialog.component.css']
})
export class PlantAndMachineryDialogComponent implements OnInit {
  private readonly matDialogRef: MatDialogRef<PlantAndMachineryDialogComponent>;
  ...
  constructor(
    matDialogRef: MatDialogRef<PlantAndMachineryDialogComponent>,
