...
@Component({
  selector: 'app-employees-count-dialog',
  templateUrl: './employees-count-dialog.component.html',
  styleUrls: ['./employees-count-dialog.component.css']
})
export class EmployeesCountDialogComponent implements OnInit {
  private readonly matDialogRef: MatDialogRef<EmployeesCountDialogComponent>;
  ...
  constructor(
    matDialogRef: MatDialogRef<EmployeesCountDialogComponent>,
